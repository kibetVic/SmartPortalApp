...
namespace SmartPortalApp.Migrations
{
    ...
    [Migration("20250512072205_newlycreatedTables")]
    partial class newlycreatedTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPortalApp.Models.Transfer", b =>
                {
                    b.HasOne("SmartPortalApp.Models.Course", "FromCourse")
                        .WithMany()
                        .HasForeignKey("FromCourseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartPortalApp.Models.Student", "Student")
                        .WithMany()
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartPortalApp.Models.Course", "ToCourse")
                        .WithMany()
